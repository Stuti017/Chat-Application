            ...
            return (
              <div
                ...
                className={`flex items-center justify-between sm:gap-x-1 md:gap-x-1 mt-5 ${
                  activeChat._id === e._id ? 'bg-[#BADCFF]' : 'bg-white'
                } cursor-pointer py-4 px-3 pe-4`}
              >
                ...
                <div className='flex flex-col items-end gap-y-[8px]'>
                  <p className='text-[12.4px] sm:text-[12px] font-normal text-[#555555] tracking-wide'>
                    {timeSince(new Date(Date.parse(e.updatedAt)))}
                  </p>
                </div>
              </div>
            );
